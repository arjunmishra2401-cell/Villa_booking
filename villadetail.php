...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM villa_reviews WHERE property_id = ?";
...
<head>
  ...
  <title>Villa - Book My Stay</title>
...
<body>
  <?php include './includes/header.php'; ?>
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM villas1 WHERE id = $hotelId";
        $result = mysqli_query($conn, $query);
        $hotel = mysqli_fetch_assoc($result);

        $sql = "SELECT * FROM nearby_villa WHERE villa_id = $hotelId";
        ...
        if ($hotel) {
            ...
            <body>
                    ...
                    <div class="hotel-details">
                        ...
                        <div class="book-now-btn"><?php
                                        if (isset($_SESSION['username'])) {
                                            // If logged in, allow booking
                                            echo '<a href="book2.php?villa_id=' . $hotel['id'] . '"><button class="btn">Book Now</button></a>';
                                        } else {
                                            // If not logged in, redirect to login
                                            echo '<a href="login.php"><button class="btn">Log in to Book</button></a>';
                                        }?>
                            </div>
            ...
            <?php
                    ...
                    echo "<p>Villa details not found.</p>";
                }
            } else {
