...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $userQuery = "SELECT useremail FROM hotel_booking WHERE username = ?";
    ...
    // Insert cab booking details into database
    $insertQuery = "INSERT INTO cab_booking_hotel (hotel_booking_id,username, pickup, dropoff, date, time, contact) VALUES (?, ?, ?, ?, ?, ?, ?)";
