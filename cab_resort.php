<?php
    ...
    <div class="modal-content">
        ...
        <form action="book_cab_resort.php" method="POST">
            ...
            <input type="text" id="dropoff" name="dropoff" value="<?php echo $booking['rname']; ?>" readonly><br><br>
