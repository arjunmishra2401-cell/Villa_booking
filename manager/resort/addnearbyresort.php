...
<body>
    <div class="form-panel">
        ...
        <form action="" method="POST">
            <input type="text" name="hotel_id" placeholder="Resort Id" value="<?php echo $rid; ?>" readonly>
            ...
            <a href="dashboard_resort.php?page=nearbyresort.php" class="logout-btn">Back</a>
        </form>
    </div>
</body>
</html>
