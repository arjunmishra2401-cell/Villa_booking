...
$qry = "select property_id from villa_managers where id = $mid";
$result = mysqli_query($conn, $qry);
$result = mysqli_fetch_assoc($result);
$pid = $result['property_id'];
$qry1 = "select id from villas1 where id = $pid";
...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO nearby_villa (villa_id,name, description, location, image_url) 
            VALUES ('$hotel_id', '$name', '$description' ,'$location', '$img_url' )";

    if (mysqli_query($conn, $sql)) {
        $success = "Villa Nearby places added successfully!";
    } else {
...
<body>
    <div class="form-panel">
        ...
        <form action="" method="POST">
            <input type="text" name="hotel_id" placeholder="Villa Id" value="<?php echo $vid; ?>" readonly>
            ...
            <a href="dashboard_villa.php?page=nearbyvilla.php" class="logout-btn">Back</a>
        </form>
    </div>
</body>
</html>
