...
$query = "SELECT * FROM `nearby_hotel` WHERE `place_id` = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE `nearby_hotel` SET `hotel_id` = ?, `name` = ?, `description` = ?, `location` = ?, `image_url` = ? WHERE `place_id` = ?";
...
<body>
    ...
    <form method="POST">
        ...
        <input type="number" id="hotel_id" name="hotel_id" value="<?php echo htmlspecialchars($place['hotel_id']); ?>" required>
        ...
        <a href="dashboard.php?page=nearbyhotel.php" class="back-btn">Cancel</a>
    </form>
</body>
</html>
