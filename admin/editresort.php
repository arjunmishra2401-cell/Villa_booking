...
// Fetch the resort details based on ID
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $result = mysqli_query($conn, "SELECT * FROM resorts1 WHERE id = $id");
    ...
    header("Location: dashboard.php?page=resort.php");
    exit();
}

// Update the resort details
...
<body>
    <div class="form-panel">
        ...
        <form action="" method="POST">
            ...
            <a href="dashboard.php?page=resort.php" class="back-btn">Back</a>
        </form>
    </div>
</body>
</html>
