...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Resort room added successfully!'); window.location.href='dashboard.php?page=resortrooms.php';</script>";
    } else {
...
<body>
    ...
    <form method="POST" action="">
        ...
        <input type="number" id="resort_id" name="resort_id" required>
        ...
        <a href="dashboard.php?page=resortrooms.php" class="logout-btn">Back</a>
    </form>
</body>
</html>
