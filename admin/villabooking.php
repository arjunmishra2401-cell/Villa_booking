...
$sql = "SELECT `booking_id`, `vid`, `vname`, `vprice`, `checkin`, `checkout`, `adult`, `child`, `username`, `fullname`, `userphno`, `useremail`, `payment_id`, `order_id`, `status` FROM `villa_booking`";
