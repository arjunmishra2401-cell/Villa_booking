...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO villas1 (name, location, price, description, features, facilities, guest_capacity, area, image_url, iframe) 
            VALUES ('$name', '$location', '$price', '$description', '$features', '$facilities', '$guest_capacity', '$area', '$image_url', '$iframe')";

    if (mysqli_query($conn, $sql)) {
        $success = "Villa added successfully!";
    } else {
...
<body>
    <div class="form-panel">
        ...
        <form action="" method="POST">
            <input type="text" name="name" placeholder="Villa Name" required>
            ...
            <input type="submit" name="submit" value="Insert Villa">
            <a href="dashboard.php?page=villa.php" class="logout-btn">Back</a>
        </form>
    </div>
</body>
</html>
