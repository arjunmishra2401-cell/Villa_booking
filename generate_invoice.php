...
if ($orderId) {
    ...
    $cabQuery = "SELECT * FROM cab_booking_hotel WHERE hotel_booking_id = ?";
        ...
        <body>
            <div class="invoice">
                ...
                <table>
                    ...
                    <tr><th>Hotel</th><td><?= htmlspecialchars($booking['hname']); ?></td></tr>
                    <tr><th>Room</th><td><?= htmlspecialchars($booking['rname']); ?></td></tr>
                    <tr><th>Check-in</th><td><?= htmlspecialchars($booking['checkin']); ?></td></tr>
                    <tr><th>Check-out</th><td><?= htmlspecialchars($booking['checkout']); ?></td></tr>
                    <tr><th>Total Price</th><td>₹<?= number_format($booking['hprice'], 2); ?></td></tr>
                    ...
                    <div class="button-row">
                        <?php if ($booking['status'] === 'pending'): ?>
                            <a href="book.php?booking_id=<?= urlencode($booking['booking_id']); ?>&room_id=<?= htmlspecialchars($booking['room_id']) ?>">
                                <button name="paynow" id="paynow">Pay Now</button>
                            </a>
                        <?php else: ?>
                            <form method="POST" action="download_invoice.php" style="display: inline;">
                        ...
                        <?php else: ?>
                            <?php if ($currentDate <= $twoDaysBeforeCheckin): ?>
                                <a href="cab_hotel.php?hotel_booking_id=<?= urlencode($booking_id); ?>">
            ...
            <div id="cabModal" class="modal">
                <div class="modal-content">
                    ...
                    <table>
                        <tr><th>Cab Booking ID</th><td><?= htmlspecialchars($cabBooking['id']); ?></td></tr>
