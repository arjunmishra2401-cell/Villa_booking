...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM hotel_reviews WHERE property_id = ?";
...
<body>
  <?php include './includes/header.php'; ?>
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM hotels1 WHERE id = $hotelId";
        $result = mysqli_query($conn, $query);
        $hotel = mysqli_fetch_assoc($result);

        $sql = "SELECT * FROM nearby_hotel WHERE hotel_id = $hotelId";
            ...
            <body>
                    ...
                    <div class="hotel-details">
                        ...
                        <div class="book-now-btn">
                                <a href="rooms.php?id=<?php echo $hotelId; ?>"><button>View Rooms</button></a>
                            </div>
